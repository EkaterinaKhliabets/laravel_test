                ...
                <div class="dropdown">
                    @if (\Illuminate\Support\Facades\Auth::user()->is_admin)
                        ...
                        <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownNavLink">
                            ...
                            <li><a class="dropdown-item" href="{{route('bankAccounts.index')}}">Банковские счета</a>
                            </li>
                            <li><a class="dropdown-item" href="{{route('currencies.index')}}">Валюты</a></li>
                            <li><a class="dropdown-item" href="{{route('rates.index')}}">Курсы валют</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="{{route('clients.index')}}">Клиенты</a></li>
                            <li><a class="dropdown-item" href="{{route('contact_faces.index')}}">Контактные лица</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="{{route('users.index')}}">Сотрудники</a></li>
                            <li><a class="dropdown-item" href="{{route('registerForm')}}">Регистрация</a></li>
                    ...
                    <div class="flex-shrink-0 dropdown">
                        <a href="#" class="d-block link-dark text-decoration-none dropdown-toggle" id="dropdownUser2"
                           data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="{{asset("storage/". \Illuminate\Support\Facades\Auth::user()->avatar)}}" alt="mdo"
                                 width="32" height="32"
                        ...
                        <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2">
                            <li><a class="dropdown-item"
                                   href="{{route('users.edit', \Illuminate\Support\Facades\Auth::user()->id)}}">Профиль</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
...
<!--
<div class="container-fluid pb-3 crm-footer">
<footer class="footer mt-auto py-3 bg-light crm-footer-text">
  {{--  <!--<div class="container">--> --}}
    <span class="text-muted ">Разработано Екатериной Хлебец, 2022 год</span>
{{--  <!--</div>--> --}}
    </footer>
    </div> -->
